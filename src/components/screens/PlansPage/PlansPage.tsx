...
import SettingsTarification from '../MainPage/ui/SettingsTarification/SettingsTarification'
import Card from '../MainPage/ui/Tarification/ui/Card/Card'
import styles from './PlansPage.module.css'
import TarificationTable from './ui/TarificationTable/TarificationTable'
// import Card from '../MainPage/ui/CardsSection/ui/Card/Card'
	...
	return (
		<div className={styles.wrapper}>
			<HeaderSection
				isMainPage={false}
				title='Тарифы'
				desc='Выберите план, который подойдет вашей команде'
				isTarification={true}
			/>
			<div className={styles.wrapperTarifications}>
